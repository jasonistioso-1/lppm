...
class DatabaseSeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        $publications = [
            [
                'title' => 'Jurnal Akuntansi Kwik Kian Gie (JAK)',
                'slug' => Str::slug('Jurnal Akuntansi Kwik Kian Gie JAK'),
                'type' => 'Jurnal',
                'author' => 'Institut Bisnis dan Informatika Kwik Kian Gie',
                'journal_name' => 'Jurnal Akuntansi',
                'year' => 2026,
                'link' => 'https://jurnal.kwikkiangie.ac.id/index.php/JAK',
                'status' => 'published',
            ],
            [
                'title' => 'Jurnal Manajemen Kwik Kian Gie (JM)',
                'slug' => Str::slug('Jurnal Manajemen Kwik Kian Gie JM'),
                'type' => 'Jurnal',
                'author' => 'Institut Bisnis dan Informatika Kwik Kian Gie',
                'journal_name' => 'Jurnal Manajemen',
                'year' => 2026,
                'link' => 'https://jurnal.kwikkiangie.ac.id/index.php/JM',
                'status' => 'published',
            ],
            [
                'title' => 'Jurnal Informatika dan Bisnis (JIB)',
                'slug' => Str::slug('Jurnal Informatika dan Bisnis JIB'),
                'type' => 'Jurnal',
                'author' => 'Institut Bisnis dan Informatika Kwik Kian Gie',
                'journal_name' => 'Jurnal Informatika dan Bisnis',
                'year' => 2026,
                'link' => 'https://jurnal.kwikkiangie.ac.id/index.php/JIB',
                'status' => 'published',
            ],
            [
                'title' => 'Jurnal Ekonomi Perusahaan (JEP)',
                'slug' => Str::slug('Jurnal Ekonomi Perusahaan JEP'),
                'type' => 'Jurnal',
                'author' => 'Institut Bisnis dan Informatika Kwik Kian Gie',
                'journal_name' => 'Jurnal Ekonomi Perusahaan',
                'year' => 2026,
                'link' => 'https://jurnal.kwikkiangie.ac.id/index.php/JEP',
                'status' => 'published',
            ],
            [
                'title' => 'Jurnal Komunikasi dan Bisnis (JKB)',
                'slug' => Str::slug('Jurnal Komunikasi dan Bisnis JKB'),
                'type' => 'Jurnal',
                'author' => 'Institut Bisnis dan Informatika Kwik Kian Gie',
                'journal_name' => 'Jurnal Komunikasi dan Bisnis',
                'year' => 2026,
                'link' => 'https://jurnal.kwikkiangie.ac.id/index.php/JKB',
                'status' => 'published',
            ],
            [
                'title' => 'Jurnal Abdimas Kwik Kian Gie (JA)',
                'slug' => Str::slug('Jurnal Abdimas Kwik Kian Gie JA'),
                'type' => 'Jurnal',
                'author' => 'Institut Bisnis dan Informatika Kwik Kian Gie',
                'journal_name' => 'Jurnal Abdimas',
                'year' => 2026,
                'link' => 'https://jurnal.kwikkiangie.ac.id/index.php/JA',
                'status' => 'published',
            ],
            [
