...
@section('title', 'Tambah Publikasi Ilmiah - LPPM')
...
<div class="mb-4">
    ...
    <h5 class="fw-bold mt-2">Tambah Data Publikasi Ilmiah Baru</h5>
</div>
...
<div class="glass-card">
    ...
    <form action="{{ route('admin.publikasi.store') }}" method="POST">
        ...
        <div class="mb-3">
            ...
            <input type="text" name="title" id="title" class="form-control" placeholder="Pengaruh Digital Marketing Terhadap Volume Penjualan UMKM..." value="{{ old('title') }}" required>
        </div>
        ...
        <div class="row">
            ...
            <div class="col-md-6 mb-3">
                ...
                <input type="text" name="author" id="author" class="form-control" placeholder="Dr. John Doe, M.M." value="{{ old('author') }}" required>
            </div>
        </div>
        ...
        <div class="row">
            <div class="col-md-6 mb-3">
                ...
                <input type="text" name="journal_name" id="journal_name" class="form-control" placeholder="Jurnal Akuntansi dan Keuangan Indonesia" value="{{ old('journal_name') }}" required>
            </div>
        ...
        <div class="mb-4">
            ...
            <input type="url" name="link" id="link" class="form-control" placeholder="https://doi.org/10.12345/jaki.v1i2..." value="{{ old('link') }}">
            <span class="text-white-50 d-block mt-1" style="font-size: 0.75rem;"><i class="fa-solid fa-circle-info me-1"></i> Tautan menuju artikel asli di situs penerbit jurnal (seperti OJS, SINTA, atau Scopus).</span>
        </div>

        <button type="submit" class="btn btn-primary px-4 py-2.5">Simpan Publikasi Ilmiah</button>
    </form>
</div>
@endsection
